        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          <div className="md:w-screen px-16">
            ...
            <form action="" className="flex flex-col gap-4">
              ...
              <input className="p-2 mt-8 rounded-xl border" type="email" name="email" placeholder="Enter Your Email"/>
              ...
              <button className="bg-[#413D3D] rounded-xl text-white hover:scale-105 duration-300 py-2">Login</button>
            </form>
            ...
            <div className="mt-3 text-xs flex justify-between items-center">
              ...
              <button className="py-2 px-5 bg-white hover:scale-110 duration-300 border rounded-xl">Register</button>
            </div>
          </div>
        </div>
      </section>
